  ...
  return (
    <>
      {categories.map((category) => {
          ...
          const visibleItemsMobile = items.slice(startIndex, startIndex + 4);
          const visibleItemsDesktop = items.slice(startIndex, startIndex + 4);
                  ...
                  {totalPages > 1 && (
                    <div className="flex items-center justify-center gap-1.5 xs:gap-2 mt-3 xs:mt-4">
                      ...
                      <button
                        ...
                        className="transition-opacity disabled:opacity-30 disabled:cursor-not-allowed ml-0.5 xs:ml-1"
                        style={{
                          color: '#e5e5e5',
                      ...
                      >
                        <svg className="w-5 h-5 xs:w-6 xs:h-6 sm:w-6 sm:h-6 md:w-8 md:h-8" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Title Section */}
                <div className="absolute top-[12%] md:top-[15%] left-[32%] max-w-xl lg:max-w-2xl xl:max-w-3xl z-20">
                  <div className={i18n.language === 'ar' ? 'text-right' : 'text-left'}>
              {/* Category Title */}
              <h2
                      className={`text-7xl xl:text-8xl text-white mb-1 md:mb-2 whitespace-nowrap -ml-8 ${
              ...
              <div className="absolute right-0 bottom-6 w-[43.5rem] overflow-hidden z-20" dir="ltr">
                <div className="pb-4">
                    <motion.div 
                      key={`desktop-${category.id}-page-${currentPage}`}
                      className="flex gap-16 pr-0 justify-start"
                      initial="hidden"
                      whileInView="visible"
